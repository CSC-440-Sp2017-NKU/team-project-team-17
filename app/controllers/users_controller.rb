...
class UsersController < ApplicationController
  ...
  def show_me
    @user = @current_user
    #adding up the scores for the questions and answers that the curent users have submitted
  ...
  def import
    ...
    respond_to do |format|
      format.html { 
        #exception handling for catching the many different exceptions that could be generated by the CSC uploading
        begin
          User.import(params[:file])
          $message = "Created Users Successfully"
        rescue
          #set a controller global message variable so that we can access it on the next refresh and load a JQuery alert popup
          $message= "#{$!}"
        ensure
